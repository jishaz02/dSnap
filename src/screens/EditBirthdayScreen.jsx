...
const EditBirthdayScreen = () => {
  return (
    <div>
      ...
      <p className=" m-2">
        Choose carefully-you can only change your birthday a limited number of
        times.
      </p>
      <input
        type="date"
        name=""
        className="w-full border-b-2 p-2 focus:outline-none text-blue-700"
      />
      {/* <p className=" text-blue-700 flex m-2">Birthday Party</p> */}
    </div>
  );
};
